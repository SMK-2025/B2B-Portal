const CACHE="b2b-matching-v1";
self.addEventListener("install",event=>{event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll(["/","/anmelden","/registrieren","/icons/b2b-matching-symbol.svg"])));self.skipWaiting()});
