...
export default function NetworksPage() {
  ...
  return <main className="v2 networkLanding">
    ...
    <section className="networkProductStory">
      ...
      <div className="networkBrowserMock" aria-label="Vorschau des Netzwerkportals"><header><i/><i/><i/><span>Ihr Netzwerkportal</span></header><div className="networkMockBody"><aside><b>UN</b><span>Übersicht</span><span>Mitglieder</span><span>Veranstaltungen</span><span>Matching</span><span>Kommunikation</span></aside><div className="networkMockMain"><small>GUTEN MORGEN</small><h3>Was bewegt Ihr Netzwerk heute?</h3><div className="networkMockMetrics"><p><b>48</b><span>Mitglieder</span></p><p><b>3</b><span>Termine</span></p><p><b>7</b><span>neue Kontakte</span></p></div><section><div><small>NÄCHSTES NETZWERKTREFFEN</small><h4>Unternehmerabend Leverkusen</h4><p>Donnerstag · 18:30 Uhr · 24 Zusagen</p><button>Teilnahme verwalten →</button></div><div><small>NEUE VERBINDUNG</small><strong>92 %</strong><h4>Bedarf trifft Kompetenz</h4><p>Zwei Mitglieder passen fachlich besonders gut zusammen.</p></div></section></div></div><em>LIVE</em></div>
    </section>
